...
import NonsillyThings from './pages/NonsillyThings/NonsillyThings'
...
const App = () => {
  ...
  const [nathansThings, setNathansThings] = useState([
    {
      name: "books",
      image: "https://imgs.xkcd.com/comics/book.png",  
      attributes: ["interesting", "varied", "not a taco", "beautiful"],
    },
  ])
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path="/the-nonsilly-things"
        element={<NonsillyThings things={nathansThings} />}
      />
    </Routes>
  )
}
